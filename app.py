...
# 5. EKRANI İKİYE BÖLÜYORUZ (Sol: %70, Sağ: %30)
sol_alan, sag_alan = st.columns([7, 3], gap="large")

# --- SAĞ SÜTUN: GİRDİ FORMLARI ---
with sag_alan:
...
# --- SOL SÜTUN: SEKMELER VE GRAFİKLER ---
with sol_alan:
